...
esri.isDefined = function (value) {
    /// <summary>Returns true when the value is neither &lt;code&gt;null&lt;/code&gt; or &lt;code&gt;undefined&lt;/code&gt;. Otherwise false.&nbsp;</summary>
...
esri.request = function (options,request) {
    ...
    /// <param name="request" type="Object" optional="false">&amp;lt;p&amp;gt;&amp;lt;code&amp;gt;request&amp;lt;/code&amp;gt; argument is an object with the following properties that describe the request. &amp;lt;/p&amp;gt; &amp;amp;lt;table class=&amp;quot;detailTable&amp;quot;&amp;gt; &amp;lt;tbody&amp;gt;&amp;lt;tr&amp;gt; &amp;lt;th class=&amp;quot;tableheader&amp;quot;&amp;gt;Property Name&amp;lt;/th&amp;gt; &amp;lt;th class=&amp;quot;tableheader&amp;quot;&amp;gt;Type&amp;lt;/th&amp;gt; &amp;lt;th class=&amp;quot;tableheader&amp;quot;&amp;gt;Description&amp;lt;/th&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;tr&amp;gt; &amp;lt;td&amp;gt;url&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;String&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Request URL. (required)&amp;lt;/td&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;tr&amp;gt; &amp;lt;td&amp;gt;content&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Object&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;If the request &amp;lt;code&amp;gt;url&amp;lt;/code&amp;gt; points to a web server that requires parameters, specify them here. The default value is null. &amp;lt;/td&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;tr&amp;gt; &amp;lt;td&amp;gt;form&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Object&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;If the request is to upload a file, specify the form element that contains the file input control here. The default value is null. Starting at version 3.3, the form parameter can be an instance of &amp;lt;a target=&amp;quot;_blank&amp;quot; href=&amp;quot;https://developer.mozilla.org/en-US/docs/DOM/XMLHttpRequest/FormData/Using_FormData_Objects&amp;quot;&amp;gt;FormData&amp;lt;/a&amp;gt;. Using FormData you can send a &amp;quot;multipart/form-data&amp;quot; request to the server without having to create an HTML form element in markup. Note that the FormData api is not available in all browsers.&amp;lt;/td&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;tr&amp;gt; &amp;lt;td&amp;gt;handleAs&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;String&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Response format. Valid values are 'json', 'xml', 'text'. The default value is 'json'.&amp;lt;/td&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;tr&amp;gt; &amp;lt;td&amp;gt;callbackParamName&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;String&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Name of the callback parameter (a special service parameter) to be specified when requesting data in JSONP format. It is ignored for all other data formats. For ArcGIS services the value is always 'callback'.&amp;lt;/td&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;tr&amp;gt; &amp;lt;td&amp;gt;timeout&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Number&amp;lt;/td&amp;gt; &amp;lt;td&amp;gt;Indicates the amount of time to wait for a response from the server. The default is &amp;lt;code&amp;gt;60000&amp;lt;/code&amp;gt; milliseconds (one minute). Set to &amp;lt;code&amp;gt;0&amp;lt;/code&amp;gt; to wait indefinitely.&amp;lt;/td&amp;gt; &amp;lt;/tr&amp;gt; &amp;lt;/tbody&amp;gt;&amp;lt;/table&amp;amp;gt;</param>
...
esri.substitute = function (data,template,first) {
    /// <summary>A wrapper around dojo.string.substitute that can also handle wildcard substitution. A wildcard uses the format of &amp;lt;code&amp;gt;${*}&amp;lt;/code&amp;gt;. If no template is provided, it is assumed to be a wildcard. This method is useful if you are not using &amp;lt;a href=&amp;quot;#graphic&amp;quot;&amp;gt;Graphic&amp;lt;/a&amp;gt; or an &amp;lt;a href=&amp;quot;#infotemplate&amp;quot;&amp;gt;InfoTemplate&amp;lt;/a&amp;gt;, but you want to embed result values in HTML, for example.</summary>
...
esri.IdentityManagerBase.prototype = 
{
    ...
    setRedirectionHandler: function (handler) {
        ...
        /// <param name="handler" type="Object" optional="false">An object containing the following redirection properties: &lt;table class="detailTABLE"&gt; &lt;tbody&gt;&lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;String&gt; resourceUrl&lt;/td&gt; &lt;td class="detailTABLE"&gt;The URL of the secure resource that triggers the redirection to the ArcGIS.com sign-in page.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#serverinfo"&gt;&lt;ServerInfo&gt;&lt;/a&gt; serverInfo&lt;/td&gt; &lt;td class="detailTABLE"&gt;ServerInfo object describing the server where the secure resource is hosted.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;String&gt; signInPage&lt;/td&gt; &lt;td class="detailTABLE"&gt;URL of the sign-in page where users will be redirected.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;String&gt; returnUrlParamName&lt;/td&gt; &lt;td class="detailTABLE"&gt;The application URL where the sign-in page redirects after a successful log-in. To create the return URL append the application's URL to &lt;code&gt;signInPage&lt;/code&gt; as a parameter. &lt;code&gt;returnUrlParamName&lt;/code&gt; contains the name of the parameter. &lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;&lt;/table&gt;</param>
    },
...
esri.Map.prototype = 
{
    ...
    setBasemap: function (basemap) {
        ...
        /// <param name="basemap" type="None" optional="false">A valid basemap name. Valid values are: "streets" , "satellite" , "hybrid", "topo", "gray", "oceans", "national-geographic", "osm".&nbsp;</param>
    },
    ...
    setLevel: function (level) {
        /// <summary>Sets the map to the specified level.  Zooms to the new level based on the current map center point. Valid only with an ArcGISTiledMapService layer.</summary>
    ...
    setScale: function (scale) {
        /// <summary>Sets the map scale to the specified value. The value must be greater than 0.&nbsp;</summary>
...
esri.dijit.AttributeInspector = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">See options list.</param>
    /// <param name="srcNodeRef" type="String" optional="false">HTML element where the attribute inspector should be rendered.&#10;
...
esri.dijit.Attribution = function (options,srcNodeRef) {
    ...
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the time slider should be rendered.&#10;
...
esri.dijit.BasemapGallery = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">Parameters used to configure the widgit. See the list below for details.</param>
    /// <param name="srcNodeRef" type="String" optional="true">Reference or id of the HTML element where the widget should be rendered. If a srcNodeRef is not provided the BasemapGallery has no user interface representation.&#10;
    /// &#60;String[]&#62; basemapIds&#10;
    /// &#60;Basemap[]&#62; basemaps&#10;
...
esri.dijit.Bookmarks = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">See options list for parameters.</param>
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the bookmark widget should be rendered.&#10;
...
esri.dijit.Gallery = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">See options list.</param>
    /// <param name="srcNodeRef" type="String" optional="false">HTML element where the  gallery should be rendered.&#10;
    /// &#60;Object[]&#62; items&#10;
    /// &#60;Boolean&#62; showTitle&#10;
...
esri.dijit.Gauge = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">See options list for parameters.</param>
    /// <param name="srcNodeRef" type="String" optional="false">HTML element where the  gauge should be rendered.&#10;
    /// &#60;String&#62; caption&#10;
    /// &#60;String&#62; color&#10;
    /// &#60;String&#62; dataField&#10;
    /// &#60;String&#62; dataFormat&#10;
...
esri.dijit.Geocoder = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">Set of parameters used to specify Geocoder options. See the options list for details. </param>
    /// <param name="srcNodeRef" type="String | DOMNode" optional="false">Reference or id of the HTML element where the widget should be rendered. &#10;
    /// &#60;Boolean || Object &#62; arcgisGeocoder&#10;
    /// &#60;boolean&#62; autoComplete&#10;
    /// &#60;boolean&#62; autoNavigate&#10;
    /// &#60;Boolean&#62; geocoderMenu&#10;
    /// &#60;Array&#62; geocodersArray&#10;
    /// &#60;Map&#62; map&#10;
    /// &#60;Number&#62; maxLocations&#10;
...
esri.dijit.Legend = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">Parameters used to configure the dijit. See the list below for details.</param>
    /// <param name="srcNodeRef" type="String" optional="false">Reference or id of the HTML element where the widget should be rendered.&#10;
    /// &#60;Number&#62; arrangement&#10;
    /// &#60;Boolean&#62; autoUpdate&#10;
    /// &#60;Object[]&#62; layerInfos&#10;
    /// &#60;Map&#62; map&#10;
...
esri.dijit.OverviewMap = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">Parameters that define the functionality of the OverviewMap widget. See the parameters information for details.</param>
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the widget should be rendered.&#10;
    /// &#60;String&#62; attachTo&#10;
    /// &#60;Layer&#62; baseLayer&#10;
    /// &#60;String&#62; color&#10;
    /// &#60;Number&#62; expandFactor&#10;
...
esri.dijit.PopupTemplate = function (popupInfo) {
    ...
    /// <param name="popupInfo" type="Object" optional="false">&lt;p&gt;An object that defines popup content. Field names can be used in the content by specifying the field name in curly brackets, for example &lt;code&gt;{description}&lt;/code&gt;. View the &lt;a href="../jshelp/#intro_popuptemplate"&gt;Popup Content&lt;/a&gt; help topic for information on the object properties. &lt;/p&gt;</param>
...
esri.dijit.Print = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">Parameters for the print widget.  See the options table below for details on the parameters.</param>
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the print widget button and drop down list will be rendered.&#10;
    /// &#60;Boolean&#62; async&#10;
    /// &#60;Map&#62; map&#10;
...
esri.dijit.Scalebar = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">Parameters used to configure the widgit. See the list below for details.</param>
    /// <param name="srcNodeRef" type="String" optional="true">Reference or id of the HTML element where the widget should be rendered.&#10;
    /// &#60;String&#62; attachTo&#10;
    /// &#60;Map&#62; map&#10;
...
esri.dijit.TimeSlider = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="String" optional="false">Parameters for the time slider object. See the options table below for parameters.</param>
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the time slider should be rendered.&#10;
...
esri.dijit.editing.TemplatePicker = function (params,srcNodeRef) {
    ...
    /// <param name="params" type="Object" optional="false">FeatureLayers or items are required all other parameters are optional. See options list.</param>
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the TemplatePicker will be rendered. Specify the HTML element using the "id" or a reference to the element."templatePickerDiv" or dojo.byId("templatePickerDiv");&#10;
    /// &#60;Number&#62; columns&#10;
    /// &#60;String&#62; emptyMessage&#10;
...
esri.geometry.xyToLngLat = function (long,lat) {
    /// <summary>Translates the given longitude and latitude to Web Mercator coordinates.&nbsp;</summary>
...
esri.layers.DynamicLayerInfo = function (json) {
    ...
    /// <param name="json" type="Object" optional="true">JSON object representing the DynamicLayerInfo.       var dynamicLayerInfo = new esri.layers.DynamicLayerInfo({	"defaultVisibility":true,	"id":0,"maxScale":1000000,	"minScale":0,	"parentLayerId":-1});</param>
...
esri.layers.FeatureLayer = function (url,options) {
    ...
    /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents a feature service. An example is &lt;code&gt;http://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Demographics/ESRI_Population_World/MapServer/0&lt;/code&gt;. For more information on constructing a URL, see &lt;a href="../jshelp/#ags_rest"&gt;The Services Directory and the REST API&lt;/a&gt;.</param>
    /// <param name="options" type="Object" optional="true">Optional parameters.  See options list.&#10;
    ...
    /// <field name="ownershipBasedAccessControlForFeatures" type="Object"> Indicates the ownership access control configuration. If ownership based access control is not enabled for the feature service the value will be null. If ownership based access control is not enabled for the feature service the value will be null. This object has two properties allowDeleteToOthers and allowUpdateToOthers. When true features can be deleted or updated by users other than the creator. {  &lt;Boolean&gt; allowUpdateToOthers,  &lt;Boolean&gt; allowDeleteToOthers}</field>
    /// <field name="relationships" type="Object[]"> Each element in the array is an object that describes the layer's relationship with another layer or table. Use the queryRelatedFeatures method to retrieve features or records related to a feature in this layer. The object has the following properties:                                  &lt;Number> id                                Unique ID for the relationship                                                                   &lt;String> name                                                  Name of the relationship.                                                                                           &lt;Number> relatedTableId                                                                    Unique ID of the related table or layer                                     </field>
...
esri.layers.FeatureLayer.prototype = 
{
    ...
    getEditCapabilities: function (options) {
        ...
        /// <param name="options" type="Object" optional="true">If the layer supports ownership based access control, use the options to determine if the specified user can edit features. &lt;i&gt;Ownership based access control requires ArcGIS Server services version 10.1 or greater&lt;/i&gt;. &lt;table class="detailTABLE"&gt; &lt;tbody&gt;&lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;graphic&gt; feature&lt;/graphic&gt;&lt;/td&gt; &lt;td class="detailTABLE"&gt;Check to see if the specified feature can be edited by the specified user.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;string&gt; userId&lt;/string&gt;&lt;/td&gt; &lt;td class="detailTABLE"&gt;The name of the currently logged in user. If the application uses the &lt;a href="#identitymanager"&gt;IdentityManager&lt;/a&gt; the IdentityManager supplies the layer with the userId so this parameter is not required.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;&lt;/table&gt;</param>
        /// <return type="Object">Object</return>
    },
    ...
    redraw: function () {
        /// <summary>Redraws all the graphics in the graphics layer. Unlike refresh(), redraw does not&nbsp;re-query&nbsp;features from the server.&nbsp;</summary>
    },
    refresh: function () {
...
esri.layers.FeatureType = function () {
    /// <summary>ScreenPoint represents a point in terms of pixels relative to the top-left corner of the map control. Prior to version 3.3, a screen point was represented using a regular Point where the point object is defined without a spatial reference.&nbsp;</summary>
    /// <field name="domains" type="Object">Map of field names to domains. For example:{  "&lt;field1>" : &lt;domain1>,  "&lt;field2>" : &lt;domain2>}In the above dictionary, if the domain defined for a field is an instance of InheritedDomain the application will use the domains defined for the field by the layer. If the dictionary does not include an entry for a field, the field does not have an associated domain.</field>
...
esri.layers.GraphicsLayer.prototype = 
{
    ...
    redraw: function () {
        /// <summary>Redraws all the graphics in the layer. This method is&nbsp;functionally&nbsp;equivalent&nbsp;to refresh.&nbsp;</summary>
    },
...
esri.layers.KMLLayer = function (id,url,options) {
    ...
    /// <field name="linkInfo" type="Object">A link info object with properties that describe the network link. The object has the following properties:{  "id": &lt;Number>,  "name": &lt;String>,  "description": &lt;String>,  "snippet": &lt;String>,  "visibility": &lt;Number>  "refreshMode": &lt;String>,  "refreshInterval": &lt;Number>,  "viewRefreshMode": &lt;String>,  "viewRefreshTime": &lt;Number>,  "viewBoundScale": &lt;Number>,  "viewFormat": &lt;String>,  "httpQuery": &lt;String>}</field>
};
...
esri.layers.WebTiledLayer = function (options,urlTemplate) {
    ...
    /// <param name="options" type="Object" optional="false">Optional parameters.  See options list.</param>
    /// <param name="urlTemplate" type="String" optional="false">The url template to retrieve the tiles. The url template follows a pattern of http://some.domain.com/${Z}/${X}/${Y}/ where Z corresponds to a zoom level, and X and Y represent tile column and row, respectively.&#10;
    /// &#60;String&#62; copyright&#10;
    /// &#60;Extent&#62; fullExtent&#10;
    /// &#60;Extent&#62; initialExtent&#10;
    /// &#60;[String]&#62; subDomains&#10;
...
esri.renderer.ClassBreaksRenderer = function (defaultSymbol,attributeField) {
    ...
    /// <field name="infos" type="Object[]">Each element in the array is an object that provides information about the class breaks associated with the renderer. The object has the following properties:                                     &lt;Number> minValue                                The minimum value.                                                            &lt;Number> maxValue                                The maximum value.                                                                  &lt;Symbol> symbol                                                  The symbol used to display the value.                                                                                          &lt;String> label                                                                    Label for the symbol used to draw the value.                                                                                                           &lt;String> description                                                                    Label for the symbol used to draw the value.                                     </field>
};

esri.renderer.ClassBreaksRenderer.prototype = 
{
    addBreak: function (minValueOrInfo,maxValue,symbol) {
...
esri.renderer.TimeClassBreaksAger = function (infos) {
    ...
    /// <param name="infos" type="Object[]" optional="false">Each element in the array is an object that describes the class breaks information. Each break info can specify a color, size or both. The features age is calculated with respect to the map's time extent end time. The object has the following properties:                                  &lt;Number> minAge                                The minimum age for the break info.                                                                  &lt;Number> maxAge                                                  The maximum age for the break info.                                                                                           &lt;dojo.Color> color                                                                    The color for the break.                                                                                                          &lt;Number> size                                                                    The size for the break.                                                                                                          &lt;Number> alpha                                                                   The alpha opacity for the break. Valid values are between 0 and 1. As of v2.8                                          &#10;
    /// &#60;String&#62; timeUnits</param>
};
...
esri.tasks.FeatureSet = function () {
    ...
    /// <field name="exceededTransferLimit" type="Number">Typically a layer has a limit on the number of features (i.e. records) returned by the query operation see &lt;a href="#featureLayer/maxRecordCount"&gt;FeatureLayer.maxRecordCount&lt;/a&gt; property. If &lt;code&gt;maxRecordCount&lt;/code&gt; is configured for a layer, &lt;code&gt;exceededTransferLimit&lt;/code&gt; will be true if a query matches more than the &lt;code&gt;maxRecordCount&lt;/code&gt; features false otherwise. &lt;i&gt;Supported by ArcGIS Server version 10.1 and later.&lt;/i&gt;</field>
...
esri.tasks.Locator = function (url) {
    ...
    /// <param name="url" type="String" optional="false">&lt;p&gt;URL to the ArcGIS Server REST resource that represents a locator service. An example is http://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Locators/ESRI_Geocode_USA/GeocodeServer. For more information on constructing a URL, see &lt;a href="../jshelp/#ags_rest"&gt;The Services Directory and the REST API&lt;/a&gt;.&lt;/p&gt;</param>
...
esri.tasks.Locator.prototype = 
{
    addressToLocations: function (params,callback,errback) {
        ...
        /// <param name="params" type="Object" optional="false">Specify the address and optionally specify the outFields and searchExtent. The searchExtent parameter requires a locator published with ArcGIS Server 10.1 or greater. &lt;table class="detailTABLE" cellspacing="0"&gt; &lt;tbody&gt;&lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;Object&gt; address&lt;/td&gt; &lt;td class="detailTABLE"&gt;Required&lt;/td&gt; &lt;td class="detailTABLE"&gt;The address argument is data object that contains properties representing the various address fields accepted by the corresponding geocode service. These fields are listed in the addressFields property of the associated geocode service resource. For example, if the addressFields of a geocode service resource includes fields with the following names: Street, City, State and Zone, then the address argument is of the form: &lt;br&gt; &lt;pre class="prettyprint"&gt;{ Street: "&lt;street&gt;", City: "&lt;city&gt;", State: "&lt;state&gt;", Zone: "&lt;zone&gt;" } &lt;/pre&gt; Locators published using ArcGIS 10 or later support a single line address field which can be specified using the following syntax: &lt;pre class="prettyprint"&gt;var address = {"Single Line Input":"380 New York St, Redlands, CA 92373"}; &lt;/pre&gt; &lt;a target="_blank" href="../jshelp/#ags_rest"&gt;Services Directory&lt;/a&gt; can be used to find out the required and optional address fields.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;String[]&gt; outFields&lt;/td&gt; &lt;td class="detailTABLE"&gt;Optional&lt;/td&gt; &lt;td class="detailTABLE"&gt;The list of fields included in the returned result set. This list is a comma delimited list of field names. If you specify the shape field in the list of return fields, it is ignored. For non-intersection addresses you can specify the candidate fields as defined in the geocode service. For intersection addresses you can specify the intersection candidate fields.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;&lt;Extent&gt; searchExtent&lt;/td&gt; &lt;td class="detailTABLE"&gt;Optional&lt;/td&gt; &lt;td class="detailTABLE"&gt;Defines the extent within which the geocode server will search. &lt;i&gt;Requires ArcGIS Server version 10.1 or greater.&lt;/i&gt; &lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;&lt;/table&gt;&nbsp;</param>
...
esri.tasks.PrintTemplate = function () {
    ...
    /// <field name="exportOptions" type="Object">Define the map width, height and dpi. Required when the layoutTemplate is set to 'MAP_ONLY'. exportOptions is an object with the following structure:  {    &lt;Number&gt; width,    &lt;Number&gt; height,    &lt;Number&gt; dpi  }</field>
    ...
    /// <field name="layoutOptions" type="Object">Define the layout elements using an object with the following properties: &nbsp;   titleText The text used for the map title if the specified layout contains a title text element.    authorText The text used for the author if the specified layout contains an author text element.    copyrightText The text used for the copyright if the specified layout contains an copyright text element.    scalebarUnit The units used for the scalebar. Valid values are 'Miles' | 'Kilometers' | 'Meters' | 'Feet'   legendLayers &lt;esri.tasks.LegendLayer[]&gt; An array of LegendLayer containing the id's of the layers that will be included in the legend. If legendLayers is not specified, all operational layers will be present in the legend. To specify that no layers will be included in the legend set legendLayer to an empty array.  customTextElements &lt;Object[]&gt; Updated the text for a TextElement, that is not DynamicText, on the page layout. Values must be strings.</field>
...
esri.tasks.RouteParameters = function () {
    ...
    /// <field name="directionsOutputType" type="String">Defines the amount of direction information returned. The default value is &lt;code&gt;standard&lt;/code&gt;.</field>
    /// <field name="directionsStyleName" type="String">The style to be used when returning directions. The default will be as defined in the network layer. View the REST layer description for your network service to see a list of supported styles.&nbsp;</field>
...
esri.toolbars.Edit.prototype = 
{
    activate: function (tool,graphic,options) {
        ...
        /// <param name="options" type="Object" optional="true">The following properties are valid options: &lt;br&gt;&lt;br&gt; &lt;table class="detailTABLE" cellspacing="0"&gt; &lt;tbody&gt;&lt;tr&gt; &lt;td class="detailTABLE"&gt;Value&lt;/td&gt; &lt;td class="detailTABLE"&gt;Description&lt;/td&gt; &lt;td class="detailTABLE"&gt;Valid geometry&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;allowAddVertices&lt;/td&gt; &lt;td class="detailTABLE"&gt;Specifies whether users can add new vertices.&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#polyline"&gt;Polyline&lt;/a&gt;, &lt;a href="#polygon"&gt;Polygon&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;allowDeleteVertices&lt;/td&gt; &lt;td class="detailTABLE"&gt;Specifies whether users can delete vertices.&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#polyline"&gt;Polyline&lt;/a&gt;, &lt;a href="#polygon"&gt;Polygon&lt;/a&gt;, &lt;a href="#multipoint"&gt;Multipoint&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;ghostVertexSymbol&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#markersymbol"&gt;MarkerSymbol&lt;/a&gt; for insertable vertices.&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#polyline"&gt;Polyline&lt;/a&gt;, &lt;a href="#polygon"&gt;Polygon&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;ghostLineSymbol&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#linesymbol"&gt;LineSymbol&lt;/a&gt; for guide lines, displayed when moving vertices.&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#polyline"&gt;Polyline&lt;/a&gt;, &lt;a href="#polygon"&gt;Polygon&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;vertexSymbol&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#markersymbol"&gt;MarkerSymbol&lt;/a&gt; for vertices.&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;a href="#polyline"&gt;Polyline&lt;/a&gt;, &lt;a href="#polygon"&gt;Polygon&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt; &lt;td class="detailTABLE"&gt;uniformScaling&lt;/td&gt; &lt;td class="detailTABLE"&gt;Boolean&lt;/td&gt; &lt;td class="detailTABLE"&gt;&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;&lt;/table&gt;</param>
    },
    deactivate: function () {
